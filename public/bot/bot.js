...
status.addListener("init", function (params, context) {
  ...
  status.sendMessage("Although me and my contracts don't charge any fees, there is a cost to register passed directly to Oraclize in order to verify your identity off-chain.");
