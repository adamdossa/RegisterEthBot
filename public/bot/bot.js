...
var RegistryAddress = "0x514141868df0586ce366061fcf49da2d8e91ef39";
...
status.addListener("init", function (params, context) {
  ...
  status.sendMessage("Although me and my contracts don't charge any fees, there is a charge from oraclize.it in order to verify your identity off-chain.");
